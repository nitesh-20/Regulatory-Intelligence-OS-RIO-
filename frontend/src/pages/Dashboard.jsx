    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-2xl bg-gradient-to-r from-slate-900 via-indigo-950/40 to-slate-900 border border-slate-800/80 shadow-2xl relative overflow-hidden">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm max-w-2xl">
            Continuous multi-agent monitoring detected 3 new amendments affecting your operations today. Your audit twin gap analysis has been refreshed.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <Link to="/ask" className="px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-xs font-semibold text-white shadow-lg shadow-indigo-600/20 transition-all flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <div key={idx} className="p-6 rounded-xl bg-slate-900/40 border border-slate-800/80 shadow-md relative overflow-hidden group hover:border-slate-700/80 transition-all duration-300">
        ...
        <div className="lg:col-span-2 p-6 rounded-xl bg-slate-900/40 border border-slate-800/80 shadow-md flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-[10px] text-indigo-400 font-semibold px-2 py-1 rounded-md bg-indigo-950/40 border border-indigo-900/40 flex items-center gap-1.5">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-slate-950/60 border border-slate-850">
                <span className="text-[10px] font-semibold text-rose-400 px-2 py-0.5 rounded bg-rose-500/10 border border-rose-500/20">
                  Critical Impact
                </span>
                ...
                <div className="mt-3 flex gap-2">
                  <Link to="/diff" className="text-[10px] text-indigo-400 font-medium hover:underline flex items-center gap-1">
              ...
              <div className="p-4 rounded-lg bg-slate-950/60 border border-slate-850">
                ...
                <div className="mt-3 flex gap-2">
                  <Link to="/twin" className="text-[10px] text-indigo-400 font-medium hover:underline flex items-center gap-1">
          ...
          <div className="mt-6 pt-4 border-t border-slate-850 flex justify-end">
            <Link to="/feed" className="text-xs text-indigo-400 font-medium hover:text-indigo-300 flex items-center gap-1">
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="flex justify-between items-center p-3 rounded-lg bg-slate-950/40 border border-slate-850">
                  <div>
                  ...
                  <span className="text-xs font-bold text-rose-400 px-2 py-1 rounded bg-rose-500/10 border border-rose-500/10">
                    {enforcement.fine}
                  </span>
                </div>
              ))}
